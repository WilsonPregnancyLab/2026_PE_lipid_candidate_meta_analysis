...
cd /workspace/lab/wilsonslab/datalake-wilsonslab/2025_RNA_Lipid_Candidate/genome_mapping/oldmapped_BAMs/
...
java --enable-native-access=ALL-UNNAMED -jar picard.jar MarkDuplicates I=/workspace/lab/wilsonslab/datalake-wilsonslab/2025_RNA_Lipid_Candidate/genome_mapping/oldmapped_BAMs/trimmed_SRR10916911_Aligned.sortedByCoord.out.bam O=./dedup.bam M=./dedup_metrics.txt 

#all bam files in directory
BAM_FILES=("/workspace/lab/wilsonslab/datalake-wilsonslab/2025_RNA_Lipid_Candidate/genome_mapping/oldmapped_BAMs/"*.bam)
#AddOrReplaceReadGroups (required for MarkDuplicates)
parallel -j 8 '
  base=$(basename {} .bam)
  ...
  java -jar picard.jar AddOrReplaceReadGroups 
    ...
    RGID=${sample_name} RGSM=${sample_name} RGPL=Illumina RGLB=${sample_name} RGPU=${sample_name}
' ::: "${BAM_FILES[@]}"
