...
lipid_candidate_probes <- read.csv("/workspace/lab/wilsonslab/eyerk/2025_Windowed_Lipid_Candidate/Lipid_Candidate_Gene_Search/lipid_candidate_probes.csv")
...
# Combined Autosomes
combined_auto_beta <- placmet_adjFunnorm_filtbetas[!rownames(placmet_adjFunnorm_filtbetas) %in% c(chrXprobes$ID, chrYprobes$ID, NAprobes$ID), ] 
# Female Autosomes
F_auto_beta <- placmet_adjFunnorm_filtfun_F[!rownames(placmet_adjFunnorm_filtfun_F) %in% c(chrXprobes$ID, chrYprobes$ID, NAprobes$ID), ] 
F_X_beta <- placmet_adjFunnorm_filtfun_F[rownames(placmet_adjFunnorm_filtfun_F) %in% c(chrXprobes$ID), ] 

# Male Autosomes
M_auto_beta <- placmet_adjFunnorm_filtfun_M[!rownames(placmet_adjFunnorm_filtfun_M) %in% c(chrXprobes$ID, chrYprobes$ID, NAprobes$ID), ] 
M_X_beta <- placmet_adjFunnorm_filtfun_M[rownames(placmet_adjFunnorm_filtfun_M) %in% c(chrXprobes$ID), ]
