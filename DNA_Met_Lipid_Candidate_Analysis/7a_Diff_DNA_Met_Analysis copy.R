...
annotation_price38 <- read.csv("/workspace/lab/wilsonslab/datalake-wilsonslab/PE_Lipid_Meta-analysis/2025_DNAm_Lipid_Candidate/Candidate_DNAm_Annotations/updated_full_annotation_region_vs_price38.csv")
...
placmet_M_fulldata_auto <- read.csv("placmet_M_fulldata_auto_rerun.csv")
placmet_M_fulldata_X <- read.csv("placmet_M_fulldata_X_rerun.csv")
placmet_F_fulldata_auto <- read.csv("placmet_F_fulldata_auto_rerun.csv")
...
wholepop_auto <- ggplot(data = plot_wholepop_auto, aes(x = deltaB_whole, y = -log10(adj.P.Val_whole), col = diffmethylation_whole)) + 
  theme_bw() +
...
male_auto <- ggplot(data = plot_M_fulldata_auto, aes(x = deltaB_M, y = -log10(adj.P.Val_M), col = diffmethylation_M)) + 
  theme_bw() +
  ylab(" ") +
  theme(axis.text = element_text(size = 14),
        axis.title = element_text(size = 18)) +
...
female_auto <- ggplot(data = plot_F_fulldata_auto, aes(x = deltaB_F, y = -log10(adj.P.Val_F), col = diffmethylation_F)) + 
   theme_bw() +
  theme(axis.text = element_text(size = 14),
        axis.title = element_text(size = 18)) +
  xlab("Delta Beta") +
...
png("./all_autosome_vol_adjFunnorm_panel_nolab.png", height = 9, width = 20, units = "in", res = 300)
