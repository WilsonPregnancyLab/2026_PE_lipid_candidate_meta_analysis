...
WG_DESeq_auto_F_pval <- WG_DESeq_auto_F[, c("gene_name", "pvalue")] 
...
# Male Autosomes
WG_DESeq_auto_M <- read.csv("/workspace/lab/wilsonslab/eyerk/PE_Lipid_Meta-analysis/2025_RNA_WG_rerun/RNA_WG_DESeq_results_autosomes_M.csv")
WG_DESeq_auto_M_pval <- WG_DESeq_auto_M[, c("gene_name", "pvalue")] 
