...
Lip_DESeq_auto_combined_sex <- read.csv("../DESeq_analysis/RNA_Lip_DESeq_results_autosomes_combined_sex.csv")
Lip_DESeq_auto_combined_sex_pval <- Lip_DESeq_auto_combined_sex[, c("gene_symbol", "pvalue")] # 4983 genes
Lip_DESeq_auto_combined_sex_pval <- Lip_DESeq_auto_combined_sex_pval[!is.na(Lip_DESeq_auto_combined_sex_pval$pvalue),] #4960
Lip_DESeq_auto_combined_sex_pval <- Lip_DESeq_auto_combined_sex_pval[!duplicated(Lip_DESeq_auto_combined_sex_pval$gene_symbol),] #4957 lipid genes investigated

Lip_DESeq_auto_combined_sex_reference <- NCBI[NCBI$GeneSymbols %in% Lip_DESeq_auto_combined_sex_pval$gene_symbol, ] #4934 genes
...
# Female Autosomes
Lip_DESeq_auto_F <- read.csv("../DESeq_analysis/RNA_Lip_DESeq_results_autosomes_F.csv")
Lip_DESeq_auto_F_pval <- Lip_DESeq_auto_F[, c("gene_symbol", "pvalue")] # 4936 genes
Lip_DESeq_auto_F_pval <- Lip_DESeq_auto_F_pval[!is.na(Lip_DESeq_auto_F_pval$pvalue),] #4919
Lip_DESeq_auto_F_pval <- Lip_DESeq_auto_F_pval[!duplicated(Lip_DESeq_auto_F_pval$gene_symbol),] # 4916 lipid genes investigated

Lip_DESeq_auto_F_reference <- NCBI[NCBI$GeneSymbols %in% Lip_DESeq_auto_F_pval$gene_symbol, ] #4898 reference genes


# Male Autosomes
Lip_DESeq_auto_M <- read.csv("../DESeq_analysis/RNA_Lip_DESeq_results_autosomes_M.csv")
Lip_DESeq_auto_M_pval <- Lip_DESeq_auto_M[, c("gene_symbol", "pvalue")] # 4876 probes
Lip_DESeq_auto_M_pval <- Lip_DESeq_auto_M_pval[!is.na(Lip_DESeq_auto_M_pval$pvalue),] #4858
Lip_DESeq_auto_M_pval <- Lip_DESeq_auto_M_pval[!duplicated(Lip_DESeq_auto_M_pval$gene_symbol),] # 4855 lipid genes investigated

Lip_DESeq_auto_M_reference <- NCBI[NCBI$GeneSymbols %in% Lip_DESeq_auto_M_pval$gene_symbol, ] #4844 genes

# Female X Chromosomes
Lip_DESeq_chrX_F <- read.csv("../DESeq_analysis/RNA_Lip_DESeq_results_chrX_F.csv")
...
# Male X Chromosome
Lip_DESeq_chrX_M <- read.csv("../DESeq_analysis/RNA_Lip_DESeq_results_chrX_M.csv")
...
Lip_DESeq_auto_combined_sex_pval <- read.csv("Lip_DESeq_auto_combined_sex_pval.csv")
Lip_DESeq_auto_combined_sex_reference <- read.csv("Lip_DESeq_auto_combined_sex_reference.csv")
