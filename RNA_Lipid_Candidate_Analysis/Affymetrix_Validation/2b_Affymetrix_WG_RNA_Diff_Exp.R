...
RNA_seq_autosomes_combined_sex <- RNA_seq_autosomes_combined_sex[RNA_seq_autosomes_combined_sex$Expression_Status %in% sig, ] #dim 79, 11

RNA_seq_autosomes_F <- read.csv("/workspace/lab/wilsonslab/eyerk/PE_Lipid_Meta-analysis/2025_RNA_WG_rerun/RNA_WG_DESeq_results_autosomes_F.csv") #dim 
RNA_seq_autosomes_F <- RNA_seq_autosomes_F[RNA_seq_autosomes_F$Expression_Status %in% sig, ] #dim 7344, 11

RNA_seq_autosomes_M <- read.csv("/workspace/lab/wilsonslab/eyerk/PE_Lipid_Meta-analysis/2025_RNA_WG_rerun/RNA_WG_DESeq_results_autosomes_M.csv") #dim 
RNA_seq_autosomes_M <- RNA_seq_autosomes_M[RNA_seq_autosomes_M$Expression_Status %in% sig, ] #dim 8746, 11
...
RNA_seq_chrX_F <- RNA_seq_chrX_F[RNA_seq_chrX_F$Expression_Status %in% sig, ] #dim 228, 11
...
RNA_seq_chrX_M <- RNA_seq_chrX_M[RNA_seq_chrX_M$Expression_Status %in% sig, ] #dim 265, 11
...
RNA_seq_chrY_M <- RNA_seq_chrY_M[RNA_seq_chrY_M$Expression_Status %in% sig, ] #dim 17, 11
...
sig_probes_auto_combined_sex <- affy_probe_data[affy_probe_data$ENSEMBL %in% RNA_seq_autosomes_combined_sex$ENS_ID,] #dim 53, 6
sig_probes_auto_F <- affy_probe_data[affy_probe_data$ENSEMBL %in% RNA_seq_autosomes_F$ENS_ID,] #dim 5839, 6
sig_probes_auto_M <- affy_probe_data[affy_probe_data$ENSEMBL %in% RNA_seq_autosomes_M$ENS_ID,] #dim 5789, 6
sig_probes_chrX_F <- affy_probe_data[affy_probe_data$ENSEMBL %in% RNA_seq_chrX_F$ENS_ID,] #dim 201, 6
sig_probes_chrX_M <- affy_probe_data[affy_probe_data$ENSEMBL %in% RNA_seq_chrX_M$ENS_ID,] #dim 197, 6
sig_probes_chrY_M <- affy_probe_data[affy_probe_data$ENSEMBL %in% RNA_seq_chrY_M$ENS_ID,] #dim 10, 6
...
linear_modeling_combined_sex(affy_metadata, affy_matrix_auto_combined_sex, "affy_AvgExpres_auto_combined_sex.csv") #39 sig genes
linear_modeling(females, affy_matrix_auto_F, "affy_AvgExpres_auto_F.csv") #496 sig genes
linear_modeling(males, affy_matrix_auto_M, "affy_AvgExpres_auto_M.csv") #586 sig genes
linear_modeling(females, affy_matrix_chrX_F, "affy_AvgExpres_chrX_F.csv") #14 sig genes
linear_modeling(males, affy_matrix_chrX_M, "affy_AvgExpres_chrX_M.csv") #17 sig genes
...
png("./XY_vol_RNA_affy_panel.png", height = 9, width = 20, units = "in", res = 300)
