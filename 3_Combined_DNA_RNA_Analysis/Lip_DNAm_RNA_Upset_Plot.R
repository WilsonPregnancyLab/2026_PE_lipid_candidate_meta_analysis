...
male_Lip <- rasterGrob(readPNG("Male_Tiered_Overlap_UpSet.png"), interpolate=TRUE)
male_WG <- rasterGrob(readPNG("Male_Tiered_Overlap_UpSet_WG.png"), interpolate=TRUE)

png("./Male_Biomarker_Upset.png", height = 9, width = 15, units = "in", res = 300)
grid.arrange(male_Lip, male_WG, nrow = 1)
dev.off()
...
png(file = "./Female_Male_RNA_Biosig_Overlap_UpSet.png", height = 8, width = 7, units = "in", res = 300)
