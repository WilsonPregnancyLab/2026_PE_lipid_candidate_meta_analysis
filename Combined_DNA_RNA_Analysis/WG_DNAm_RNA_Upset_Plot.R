...
head(f_upset_table) #RAB5C, nonbiosig = CSNK1D
...
head(m_upset_table) #PDLIM2, SLC2A1
...
png(file = "./Female_Male_RNA_Biosig_Overlap_UpSet_WG.png", height = 8, width = 12, units = "in", res = 300)
